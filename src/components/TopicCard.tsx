...
export default function TopicCard(props: Property) {
  return (
    <article className="w-full p-4 flex flex-col gap-4 border border-neutral-600 rounded-lg bg-neutral-900">
      {/* 상단 부분 */}
      <figure className="w-full flex flex-row items-center gap-4">
        <img
          src={props.thumbnailSrc}
          className="w-30 min-w-30 aspect-square rounded-xl object-cover"
        />
